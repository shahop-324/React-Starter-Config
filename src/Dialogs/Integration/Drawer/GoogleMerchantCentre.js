...
const GoogleMerchantCentre = ({ open, handleClose }) => {
  ...
  const [verificationCode, setVerificationCode] = useState(store.GMCVerificationCode);
        ...
        <Drawer anchor={'right'} open={open} onClose={handleClose}>
          <Box sx={{ my: 3, mx: 4, width: '400px' }}>
            <Stack direction="row" alignItems="center" justifyContent="space-between">
              <Typography variant="h6">Google Merchant</Typography>
...
export default GoogleMerchantCentre;
