...
import { updateSubCategoryStock } from '../../actions';
    ...
    <>
      <Dialog fullWidth maxWidth="sm" open={open}>
        ...
        <Box sx={{ px: 4, py: 3 }}>
          <Card
            onClick={() => {
              dispatch(updateSubCategoryStock(id, { outOfStock: true, hidden: true }, handleClose));
            }}
            className="clickable"
            sx={{ mb: 3, p: 2 }}
          >
            <Stack direction="row" alignItems="center" spacing={3}>
              ...
              <Stack direction={'column'} spacing={1}>
                ...
                <Typography variant="caption">This will hide this sub category from store.</Typography>
              </Stack>
            </Stack>
          </Card>
          <Card
            onClick={() => {
              dispatch(updateSubCategoryStock(id, { outOfStock: true }, handleClose));
            }}
            className="clickable"
            sx={{ p: 2 }}
          >
            <Stack direction="row" alignItems="center" spacing={3}>
              ...
              <Stack direction={'column'} spacing={1}>
                ...
                <Typography variant="caption">This sub category will still be shown but marked as out of stock.</Typography>
              </Stack>
            </Stack>
          </Card>
        </Box>
