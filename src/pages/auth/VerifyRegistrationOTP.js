...
import { showSnackbar, resendMobileOTPForRegistration, resetVerifyEmailViaOTP } from '../../actions';
import LogoOnlyLayout from '../../layouts/LogoOnlyLayout';
// components
import Page from '../../components/Page';
import Iconify from '../../components/Iconify';
// sections
import { VerifyRegistrationCodeForm } from '../../sections/auth/verify-code';
              ...
              {!isReSendingOTP ? (
                <Link
                  ...
                  onClick={() => {
                    ...
                    dispatch(resendMobileOTPForRegistration(mobile));
                  }}
                >
